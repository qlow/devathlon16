...
public class ConfigManager<T> {
    ...
    private void loadConfig( boolean reload ) {
        // Info message
        System.out.println( "Loading " + file.getName() + " config.." );
        ...
        try {
            ...
            // Info message
            System.out.println( this.settings != null ? "Loaded " + file.getName() + "!" : "Loaded file but settings is null" );
            ...
            System.out.println( "Failed to load " + file.getName() + " config!" );
