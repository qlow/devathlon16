    ...
    private void makePortal( boolean left ) {
        ...
        for ( Block block : blocks ) {
            ...
            if ( block.getType() == Material.AIR || block.getType() == Material.WATER || block.getType() == Material.STATIONARY_WATER ) {
                ...
                packetContainer.getShorts().write( 0, (short) 0 );                      // Vector-X
                packetContainer.getShorts().write( 1, (short) 0 );                      // Vector-Y
                packetContainer.getShorts().write( 2, (short) 0 );                      // Vector-Z
